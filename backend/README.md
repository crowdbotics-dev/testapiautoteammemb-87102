...
## Project Structure
    ...
    ├── testapiautoteammemb_87102  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_87102`
...
2. Clone this repo and `cd testapiautoteammemb_87102`
